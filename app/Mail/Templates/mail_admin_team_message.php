        ...
        <td style="padding:30px;line-height:1.7;">
            ...
            <?php if (!empty($sender)): ?>
                <p style="margin:0 0 10px;">
                    Absender: <strong><?= htmlspecialchars($sender) ?></strong>
                </p>
            <?php endif; ?>

            <?php if (!empty($subject)): ?>
                <p style="color:#b5b5b5;margin:0 0 10px;">
                    Betreff: <strong><?= htmlspecialchars($subject) ?></strong>
                </p>
            <?php endif; ?>

            <div style="color:#b5b5b5;margin-top:12px;">
                <?= nl2br(htmlspecialchars($message)) ?>
            </div>

            <p style="margin-top:18px;font-size:12px;color:#9a9a9a;">
                ℹ️ Interne Systemnachricht – bitte nicht weiterleiten.
            </p>
        </td>
    </tr>
