...
class ForumController
{
    ...
    public function thread(int $id): void
    {
        $thread = Database::fetch(
            'SELECT t.*, u.username, c.title AS category_title, c.slug AS category_slug
             FROM forum_threads t
             JOIN users u ON u.id = t.user_id
    ...
    public function storeThread(string $slug): void
    {
        ...
        Security::checkCsrf(); // Verwende die Security-Klasse für CSRF-Prüfung
